...
from workers import cards, cowriter, documents as documents_worker, email as email_worker, extraction, jobs, memory_prescient, research, weekly_diff  # noqa: F401
from routers import (
    auth as auth_router,
    chat,
...
async def lifespan(app: FastAPI):
    ...
    # Bootstrap strand registry (idempotent — safe to run every startup)
    from services.strands import strand_bootstrap
    asyncio.create_task(strand_bootstrap())
